(function ($) {
    ...
    $.fn.eCalendar.defaults = {
        ...
        months: ['Janvier', 'Février', 'Mars', 'Avril', 'Mai', 'Juin', 'Juillet', 'Août', 'Septembre', 'Octobre', 'Nomvembre', 'Décembre'],
        textArrows: {previous: '<', next: '>'},
        eventTitle: 'Réservations',
        url: '',
        events: [
            {title: 'Pas de réservations.', description: "Aucun matérie n'a encore été réservé", datetime: new Date(2016, new Date().getMonth(), 12, 17)}
        ],
        firstDayOfWeek: 0
    };
